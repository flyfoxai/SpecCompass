...
| [SpecCompass PRD](docs/reference/speccompass-product-requirements.zh-CN.md) | Authoritative product requirements for the SP workflow and artifact contracts. |
