...
> **Important:** SpecCompass is installed from this fork, `flyfoxai/SpecCompass`. The upstream baseline is [github/spec-kit](https://github.com/github/spec-kit), but installing from upstream gives you the original workflow rather than the SpecCompass commands and templates. Any package with the same name on PyPI is not maintained by this fork.

### Initialize a New Project

The easiest way to get started is to initialize a new project. Pin a specific release tag for stability when releases are available:

```bash
# Install from a specific stable release (recommended — replace vX.Y.Z with the latest tag)
uvx --from git+https://github.com/flyfoxai/SpecCompass.git@vX.Y.Z specify init <PROJECT_NAME>
...
```bash
uvx --from git+https://github.com/flyfoxai/SpecCompass.git@vX.Y.Z specify init .
# or use the --here flag
uvx --from git+https://github.com/flyfoxai/SpecCompass.git@vX.Y.Z specify init --here
```
...
```bash
uvx --from git+https://github.com/flyfoxai/SpecCompass.git@vX.Y.Z specify init <project_name> --integration claude
uvx --from git+https://github.com/flyfoxai/SpecCompass.git@vX.Y.Z specify init <project_name> --integration gemini
uvx --from git+https://github.com/flyfoxai/SpecCompass.git@vX.Y.Z specify init <project_name> --integration codex
uvx --from git+https://github.com/flyfoxai/SpecCompass.git@vX.Y.Z specify init <project_name> --integration codebuddy
uvx --from git+https://github.com/flyfoxai/SpecCompass.git@vX.Y.Z specify init <project_name> --integration pi
```
...
```bash
uvx --from git+https://github.com/flyfoxai/SpecCompass.git@vX.Y.Z specify init <project_name> --script sh
uvx --from git+https://github.com/flyfoxai/SpecCompass.git@vX.Y.Z specify init <project_name> --script ps
```
...
```bash
uvx --from git+https://github.com/flyfoxai/SpecCompass.git@vX.Y.Z specify init <project_name> --integration claude --ignore-agent-tools
```
