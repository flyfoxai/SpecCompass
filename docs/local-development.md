...
```bash
uvx --from . specify init demo-uvx --integration codex --ignore-agent-tools --script sh
```
...
uvx --from git+https://github.com/flyfoxai/openSpecs.git@your-feature-branch specify init demo-branch-test --script ps
```
...
```bash
uvx --from /mnt/c/GitHub/openSpecs specify --help
uvx --from /mnt/c/GitHub/openSpecs specify init demo-anywhere --integration codex --ignore-agent-tools --script sh
```

Set an environment variable for convenience:

```bash
export SPEC_KIT_SRC=/mnt/c/GitHub/openSpecs
...
```bash
specify-dev() { uvx --from /mnt/c/GitHub/openSpecs specify "$@"; }
# Then
specify-dev --help
```
...
| Local uvx run (abs path) | `uvx --from /mnt/c/GitHub/openSpecs specify ...` |
