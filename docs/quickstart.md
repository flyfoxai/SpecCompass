...
uvx --from git+https://github.com/flyfoxai/openSpecs.git specify init .
```

Pick script type explicitly (optional):

```bash
uvx --from git+https://github.com/flyfoxai/openSpecs.git specify init <PROJECT_NAME> --script ps  # Force PowerShell
uvx --from git+https://github.com/flyfoxai/openSpecs.git specify init <PROJECT_NAME> --script sh  # Force POSIX shell
```
