...
| [Claude Code](https://www.anthropic.com/claude-code)                                 | `claude`         | Installs project slash commands into `.claude/commands/sp.<command>.md`; stale core skills under `.claude/skills` are cleaned to avoid duplicate slash entries |
| [CodeBuddy CLI](https://www.codebuddy.ai/cli)                                        | `codebuddy`      |                                                                                                                                           |
| [Codex CLI](https://github.com/openai/codex)                                         | `codex`          | Skills + prompt + plugin integration; installs executable skills into `.agents/skills/sp-<command>/SKILL.md`, prompt companions into `.codex/prompts/sp.<command>.md`, and a project-local plugin surface with `.agents/plugins/marketplace.json` plus `plugins/sp/`; these files target `/prompt::sp.<command>`, but slash-menu visibility depends on the current Codex client |
