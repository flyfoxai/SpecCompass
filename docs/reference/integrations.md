...
| [Codex CLI](https://github.com/openai/codex)                                         | `codex`          | Skills-based integration; installs core command skills into `.agents/skills/sp-<command>/SKILL.md`; user-facing SP commands remain `/sp.*` |
