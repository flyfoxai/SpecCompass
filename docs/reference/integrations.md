...
| [Codex CLI](https://github.com/openai/codex)                                         | `codex`          | Skills-first integration; use `$` or `/skills` in Codex and choose `sp-<command>`. Installs executable skills into `.agents/skills/sp-<command>/SKILL.md`; deprecated prompt/plugin command surfaces are not part of the success criterion |
