...
| find unresolved questions, todos, risks, blockers, rollback advice, or close conditions | `memory/open-items.md` | `analysis.md`, `delivery/09-events-and-side-effects.md`, `delivery/12-test-and-acceptance.md` | depends on the matched open item |
