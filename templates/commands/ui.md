...
- Confirm upstream flow `Stage Readiness` is present in `specs/<feature>/flows/index.md` or `specs/<feature>/memory/index.md` and has `Status: READY_FOR_UI`.
