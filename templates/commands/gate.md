...
- If `BLOCKED` or `NEEDS_DECISION`, include the failure-site or decision summary, 2-4 options when human input is required, the recommendation, and the exact next `/sp.*` route.
