...
from specify_cli.command_names import canonical_command_id, command_filename_base
...
class CopilotIntegration(IntegrationBase):
    ...
    def dispatch_command(
        ...
        *,
        ...
        """Dispatch via ``--agent <command-id>`` instead of slash-commands.
        ...
        agent_name = canonical_command_id(command_name)
    ...
    def command_filename(self, template_name: str) -> str:
        ...
        return f"{command_filename_base(template_name)}.agent.md"
    ...
    def setup(
        ...
        **opts: Any,
        ...
        for src_file in templates:
            cmd_name = canonical_command_id(src_file.stem)
            prompt_content = f"---\nagent: {cmd_name}\n---\n"
