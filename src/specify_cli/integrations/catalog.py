...
class IntegrationCatalog:
    ...
    DEFAULT_CATALOG_URL = (
        "https://raw.githubusercontent.com/flyfoxai/SpecCompass/main/integrations/catalog.json"
    )
    COMMUNITY_CATALOG_URL = (
        "https://raw.githubusercontent.com/flyfoxai/SpecCompass/main/integrations/catalog.community.json"
    )
